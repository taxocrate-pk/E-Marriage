      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 border-b border-white/10 pb-14 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-white/60">
              <Link href="/online-marriage">Online marriage</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-white/60">
              <Link href="/marriage-documentation">Marriage documents</Link>
              <Link href="/marriage-certificate">Marriage certificate</Link>
