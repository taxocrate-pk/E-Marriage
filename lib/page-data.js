...
function createPage({ slug, shortTitle, eyebrow, heading, intro, overviewTitle, overview, considerations, faqFocus, related }) {
  const title = `${shortTitle} | International Guidance | E-Marriages`
...
export const pages = {
  ...
  'marriage-registration': createPage({
    slug: 'marriage-registration', shortTitle: 'Marriage Registration', eyebrow: 'Creating an official civil record', heading: 'Marriage registration guidance for local records and international use.',
    intro: 'Understand which authority should register the marriage, how the primary record becomes an official certificate and what later verification may involve.',
    overviewTitle: 'A ceremony and civil registration are related but distinct steps.', overview: 'A marriage may be solemnised through a religious, civil, remote or proxy procedure, yet the official record depends on the competent registration system. Delayed or incomplete registration can create avoidable difficulties abroad.',
    considerations: [['Competent authority', 'Identify the registrar, municipality, Union Council or civil office responsible for the record.'],['Accurate entry', 'Names, dates, addresses and identity references should match supporting documents.'],['Certified record', 'Determine whether an extract, certificate or computerised record is needed.'],['Verification abroad', 'The receiving authority may require authentication, translation or independent verification.']],
    faqFocus: 'marriage registration', related: ['marriage-documentation','marriage-certificate','certified-translation']
  }),
  'certified-translation': createPage({
    slug: 'certified-translation', shortTitle: 'Certified Marriage Document Translation', eyebrow: 'Marriage documents across languages', heading: 'Certified translation guidance for marriage certificates and civil records.',
    intro: 'Prepare marriage documents for use in another language while preserving names, dates, seals, annotations and the evidential link to the original record.',
    overviewTitle: 'A translation must be accurate and acceptable to the receiving authority.', overview: 'Different authorities use “certified”, “sworn” and “official” translation differently. The translator’s qualification, declaration, formatting and attachment to the source document should suit the destination requirement.',
    considerations: [['Destination standard', 'Confirm the authority’s accepted translator and certification format.'],['Name consistency', 'Transliteration should align with passports and existing civil records.'],['Complete translation', 'Seals, stamps, marginal notes and endorsements may also need translation.'],['Authentication sequence', 'Check whether translation occurs before or after apostille or legalisation.']],
    faqFocus: 'a certified translation of marriage documents', related: ['marriage-documentation','marriage-certificate','apostille-attestation']
  }),
}
